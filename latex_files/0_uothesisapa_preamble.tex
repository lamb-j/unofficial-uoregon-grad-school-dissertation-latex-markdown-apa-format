...
\documentclass[dissertation, apacite, copyright, approved, final]{uothesisapa} % For final copies
  % Add 'approved' to the list of options to add the Approval page.
...
%--- apacite+bibtex. For example:
%--- If using biblatex, you need to manualy fix spacing.
